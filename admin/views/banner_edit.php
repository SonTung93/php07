                            ...
                            <div class="row">
                                <form action="" method="post" class="form-horizontal"  enctype="multipart/form-data" name="form-menu" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" value="<?php echo $this->result['name']; ?>" name="name" class="form-control" required placeholder="Name">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <?php if ($this->result['image'] != '') : ?>
                                                    <img src="<?php echo ROOT . '/upload/Images/Banner/' . $this->result['image']; ?>" width="200" />
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" value="<?php echo $this->result['content'] ?>" name="content" class="form-control" placeholder="Nội dung"> 
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" value="<?php echo $this->result['url'] ?>" name="url" class="form-control" placeholder="Url">
                                            </div>
                                        </div>
