                        ...
                        <div class="panel-body ">
                            <div class="row">
                                <form action="" method="post" class="form-horizontal"  enctype="multipart/form-data" name="form-menu" id="">
                                            ...
                                            <div class="col-md-10">
                                                <select class="form-control selectpicker" data-live-search="true"  data-style="btn-info" name="category_id">
                                                   <option value="0" selected="selected">Tất cả category</option>
                                                    <?php $this->loadSelect(0, $this->result['category_id']);?>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                ...
                                                <?php if ($this->result['image'] != '') : ?>
                                                    <img src="<?php echo ROOT . '/upload/Images/Product/' . $this->result['image']; ?>" width="200" />
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-2">Giá cũ:</label>
                                            <div class="col-md-10">
                                                <input type="text" value="<?php echo $this->result['price_old'] ?>" name="price_old" class="form-control">
                                            </div>
                                        </div>
