    ...
    <div class="page-heading">
        ...
        <div class="col-md-8 pull-right">
            <div class="pull-right">
                <a href="<?php echo ROOT . '/admin/order/change/status'; ?>" data-status="0" class="btn btn-danger m-l-5 change_status">
                    Đang thực hiện<i class="fa fa-eye-slash"></i>
                </a>
                <a href="<?php echo ROOT . '/admin/order/change/status'; ?>" data-status="1" class="btn btn-success m-l-5 change_status">
                    Xong <i class="fa fa-eye"></i>
                </a>
                <a href="<?php echo ROOT . '/admin/order/create'; ?>" class="btn btn-primary m-l-5">
                        ...
                        <div class="panel-body panel-no-padding">
                                        ...
                                        <?php if (count($this->result) > 0) : ?>
                                            ...
                                            <?php foreach ($this->result as $key => $value) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php echo $this->product->getProductByID($value['product_id'])['name'] ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $this->attribute_product->getAttributeProductByID($value['attribute_product_id'])['name'] ?>
                                                    </td>
                                                    <td >
                                                    ...
                                                    <td >
                                                        <?php if ($value['status'] == 0) : ?>
                                                            <span class = "label label-danger w-300"><?php echo $this->common->getOrderStatus($value['status']); ?></span>
                                                        <?php else : ?>
                                                            <span class = "label label-success w-300"><?php echo $this->common->getOrderStatus($value['status']); ?></span>
                                                        <?php endif; ?>
                                                    </td>

                                                    <td class="vam td-btn">
                                                        <a class=" btn btn-xs btn-default  btn-delete-data" data-id="<?php echo $value['id']; ?>" href="<?php echo ROOT . '/admin/order/delete/' . $value['id']; ?>"><i class="fa fa-times-circle"></i> Xóa</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                            ...
                            <div class="panel-footer p10 m0">
                                ...
                                <ul class="pagination pagination-sm m0 pull-right">
                                    <li class="<?php echo (($this->page - 1) > 0) ? '' : 'disabled'; ?>"><a href="<?php echo ROOT . '/admin/order?page=' . ($this->page - 1) ; ?>"><i class="fa fa-angle-left"></i></a>
                                    </li>
                                    <?php for ($i = $min; $i <= $max; $i++) : ?>
                                        <li class="paginate_button <?php echo $this->page == $i ? 'active' : ''; ?>" aria-controls="products-table" tabindex="0">
                                            <a href="<?php echo ROOT . '/admin/order?page=' . $i ?>"><?php echo $i; ?></a>
                                        </li>
                                    <?php endfor; ?>
                                    <li class="<?php echo (($this->page + 1) > $this->pagination) ? 'disabled' : ''; ?>"><a href="<?php echo ROOT . '/admin/order?page=' . ($this->page + 1); ?>"><i class="fa fa-angle-right"></i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
