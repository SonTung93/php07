    ...
    <div class="page-heading">
        ...
        <div class="col-md-8 pull-right">
            <div class="pull-right">
                <a href="<?php echo ROOT . '/admin/user/change/status'; ?>" data-status="0" class="btn btn-danger m-l-5 change_status">
                    Khóa <i class="fa fa-eye-slash"></i>
                </a>
                <a href="<?php echo ROOT . '/admin/user/change/status'; ?>" data-status="1" class="btn btn-success m-l-5 change_status">
                    Hoạt động <i class="fa fa-eye"></i>
                </a>
            </div>
        </div>
    </div>
                                        ...
                                        <?php if (count($this->result) > 0) : ?>
                                            ...
                                            <?php foreach ($this->result as $key => $value) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo ROOT . '/admin/user/edit/' . $value['id']; ?>"><?php echo $value['name']; ?></a>
                                                    </td>
                                                    ...
                                                    <td >
                                                        <?php if ($value['status'] == 0) : ?>
                                                            <span class = "label label-danger w-300"><?php echo $this->common->getUserStatus($value['status']); ?></span>
                                                        <?php else : ?>
                                                            <span class = "label label-success w-300"><?php echo $this->common->getUserStatus($value['status']); ?></span>
                                                        <?php endif; ?>
                                                    </td>

                                                    <td class="vam td-btn">
                                                        <a class=" btn btn-xs btn-default" href="<?php echo ROOT . '/admin/user/edit/' . $value['id']; ?>"><i class="fa fa-info-circle"></i> Sửa</a>
                                                        <a class=" btn btn-xs btn-default  btn-delete-data" data-id="<?php echo $value['id']; ?>" href="<?php echo ROOT . '/admin/user/delete/' . $value['id']; ?>"><i class="fa fa-times-circle"></i> Xóa</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                ...
                                <ul class="pagination pagination-sm m0 pull-right">
                                    ...
                                    <?php for ($i = $min; $i <= $max; $i++) : ?>
                                        <li class="paginate_button <?php echo $this->page == $i ? 'active' : ''; ?>" aria-controls="products-table" tabindex="0">
                                            <a href="<?php echo ROOT . '/admin/user?page=' . $i . ($this->search != '' ? '&search=' . $this->search : ''); ?>"><?php echo $i; ?></a>
                                        </li>
                                    <?php endfor; ?>
