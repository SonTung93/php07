    ...
    <div class="page-heading">
        ...
        <div class="col-md-8 pull-right">
            <div class="pull-right">
                <a href="<?php echo ROOT . '/admin/attribute/change/status'; ?>" data-status="0" class="btn btn-danger m-l-5 change_status">
                    Ẩn <i class="fa fa-eye-slash"></i>
                </a>
                <a href="<?php echo ROOT . '/admin/attribute/change/status'; ?>" data-status="1" class="btn btn-success m-l-5 change_status">
                    Hiện <i class="fa fa-eye"></i>
                </a>
                <a href="<?php echo ROOT . '/admin/attribute/create'; ?>" class="btn btn-primary m-l-5">
                                        ...
                                        <?php if (count($this->result) > 0) : ?>
                                            ...
                                            <?php foreach ($this->result as $key => $value) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo ROOT . '/admin/attribute/edit/' . $value['id']; ?>"><?php echo $value['name']; ?></a>
                                                    </td>
                                                    
                                                    <td>
                                                        <?php 
                                                            $list_id = explode(',',$value['category_id']);
                                                            foreach ($list_id as $rows) {
                                                                echo $this->category->getCategoryNameByID($rows)."|";
                                                            }
                                                        ?>
                                                    </td>
                                                    ...
                                                    <td >
                                                        <?php if ($value['status'] == 0) : ?>
                                                            <span class = "label label-danger w-300"><?php echo $this->common->getAttributeStatus($value['status']); ?></span>
                                                        <?php else : ?>
                                                            <span class = "label label-success w-300"><?php echo $this->common->getAttributeStatus($value['status']); ?></span>
                                                        <?php endif; ?>
                                                    </td>

                                                    <td class="td-btn">
                                                        <a class=" btn btn-xs btn-default" href="<?php echo ROOT . '/admin/attribute/edit/' . $value['id']; ?>"><i class="fa fa-info-circle"></i> Sửa</a>
                                                        <a class=" btn btn-xs btn-default  btn-delete-data" data-id="<?php echo $value['id']; ?>" href="<?php echo ROOT . '/admin/attribute/delete/' . $value['id']; ?>"><i class="fa fa-times-circle"></i> Xóa</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
